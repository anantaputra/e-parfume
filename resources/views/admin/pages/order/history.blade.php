                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('admin.order.view', ['id' => $order->uuid]) }}" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tracking Number"><i class="fa fa-truck"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
